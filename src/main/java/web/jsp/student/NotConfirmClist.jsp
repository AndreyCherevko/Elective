...
<html>
    ...
    <body>
        <clist:GetConfirmStudentCourses confirm="false"/>
        <c:choose>
            <c:when test="${requestlist.size()>0}">
                ...
                </table>  <center><button class="btn blue" type="submit" name="goto" value="STUDENT_MAIN_PAGE_PATH"><fmt:message key="STUDENT_MAIN_TITLE"/></button></center>
            </c:when>
            <c:otherwise>
            <br>
            ...
            <form name="courseform" method="POST" action="controller">
                ...
                <input type="hidden" name="command" value="redirect"/><br>
